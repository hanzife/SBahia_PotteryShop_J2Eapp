            ...
            <c:forEach items="${articleCarte}" var="a"  >
                <div class="border-2 border-light-blue-500 border-opacity-25 rounded-2xl w-100 h-72 relative">
                    ...
                    <div class="w-4/5 h-44 bg-gray-600 mx-auto mt-6 relative">
                        <!-- Delete -->
                        <a  href="Delete.test?id=${a.getIdArticle()}" class="absolute rounded-2xl  top-2 right-2 h-14 w-14 bg-gray-100">
                    ...
                    <button
                            onclick="updateForm()" id="updateBTN" class="absolute inset-x-0 bottom-0 h-16 w-full bg-gray-100 rounded-2xl text-center">
                        <p ><p id="articlePrice">${a.getPrice()}</p><span class="">DH</span></p>
    ...
    <div class="w-3/6 bg-gray-50">
        ...
        <div class="w-5/6 mx-auto">
            ...
            <form method="post" action="Ajouter.test" enctype="multipart/form-data" class="relative" id="formArticle">
                ...
                <textarea type="text" name="Desc" id="updateDESC" class="w-full rounded-lg h-48 bg-gray-100 mt-6"></textarea>
